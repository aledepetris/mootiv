...
import { TrainerRequest } from 'src/app/main/interfaces/TrainerRequest.interface';
...
export class TrainerComponent implements OnInit {
    ...
    onSubmit(): void {
        this.trainerForm.students = this.selectedStudents;
        ...
        this.trainersService.getTrainerById(trainerId).subscribe({
          next: (trainer) => {
            this.trainerForm = {
              ...
              students: trainer.students ? trainer.students.map((student: any) => student.id) : []
            };
            this.selectedStudents = this.trainerForm.students;
          },
          error: (error) => {
