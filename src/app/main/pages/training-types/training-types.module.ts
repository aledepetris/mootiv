...
import { TrainingTypesRoutingModule } from './training-types-routing.module';
import { TrainingTypeImagePipe } from './training-types-image.pipe';
...
@NgModule({
    declarations: [
        ...
        TrainingTypeImagePipe
    ],
    imports: [
        CommonModule,
        FormsModule,
        TrainingTypesRoutingModule,
        DataViewModule,
        PickListModule,
        OrderListModule,
        InputTextModule,
